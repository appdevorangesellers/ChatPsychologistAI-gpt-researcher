...
import io
from multi_agents.agents import MedResearchAgent, SymptomResearchAgent
...
async def handle_research_disorder(disorder):
    #researcher = GPTResearcher()
    #await researcher.conduct_symptom_research(disorder)
