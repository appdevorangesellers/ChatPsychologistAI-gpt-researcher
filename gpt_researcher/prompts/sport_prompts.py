...
The report should mainly focus on {topic}. Each sport activity's summary should be well structured, informative, in-depth, and comprehensive, with facts and numbers if available. The report totally should be at least {total_words} words.
