...
These are a possible list of headings: ['lifestyles with positive impact', 'lifestyles with negative impact'].
...
- You should strive to mention all {topic} provided in context!.
