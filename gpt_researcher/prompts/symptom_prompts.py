...
def generate_symptom_list_prompt():
    return """
Construct a list of symptoms for {task}.
You are a seasoned research assistant tasked with generating a list of symptoms for {task}.

Research data:
{data}

Use research data to inform and refine the list of symptoms. The research data provides real-time web information that can help you generate more specific and relevant list. Consider any current events, recent developments, or specific details mentioned in the context that could enhance the response.
There should NOT be any duplicate symptoms. The symptoms should be concise and grouped according to similarity.

"IMPORTANT!":
- Every symptom MUST be relevant to {task} and to provided research data ONLY!
